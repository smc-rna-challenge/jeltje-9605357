SMC-RNA Challenge Entry: jeltje-9605357
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/jeltje-9605357
cd jeltje-9605357
...
- [quay.io/smc-rna-challenge/jeltje-9605357-rsem:1.0.0](https://quay.io/smc-rna-challenge/jeltje-9605357-rsem:1.0.0)
...
[data]: https://www.synapse.org/#!Synapse:syn9878818
